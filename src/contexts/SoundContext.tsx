...
export const SoundProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const [musicVolume, setMusicVolume] = useState(0.3); // Separate music volume
    ...
    useEffect(() => {
        ...
        // Download: https://www.youtube.com/watch?v=gKfmEzGemIQ (The Good Place Theme)
        // Save as: public/background-music.mp3
